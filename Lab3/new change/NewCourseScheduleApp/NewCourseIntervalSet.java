...
import adt.impl.NonPeriodicMultiIntervalSetImpl;
...
public class NewCourseIntervalSet<L> extends CommonMultiIntervalSet<L> implements ICourseIntervalSet<L> {
    ...
    public NewCourseIntervalSet(long periodStart, int week_num) {
    ...
    public boolean equals(Object o) {
        ...
        NewCourseIntervalSet<?> that = (NewCourseIntervalSet<?>) o;
