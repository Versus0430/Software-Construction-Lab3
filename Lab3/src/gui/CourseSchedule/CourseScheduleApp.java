...
public class CourseScheduleApp {
    ...
    private static CourseIntervalSet<Course> courseIntervalSet;
    ...
    public static void main(String[] args) {
        ...
        while(true) {
            ...
            courseIntervalSet = new CourseIntervalSet<>(startTime.toLong() * 24L,totalWeekNum);
            break;
        }
                        ...
                        for (int k = 0; k < line.length; k++) {
                            ...
                            switch (ch) {
                                case 0:
                                    break;
                                case 1:
                                    courseIntervalSet.insert(8 + i * 24, 10 + i * 24, c);
                                    timeRecord[i][0]++;
                                    c.addStartTime(8 + i * 24);
                                    num++;
                                    break;
                                case 2:
                                    courseIntervalSet.insert(10 + i * 24, 12 + i * 24, c);
                                    timeRecord[i][1]++;
                                    c.addStartTime(10 + i * 24);
                                    num++;
                                    break;
                                case 3:
                                    courseIntervalSet.insert(13 + i * 24, 15 + i * 24, c);
                                    timeRecord[i][2]++;
                                    c.addStartTime(13 + i * 24);
                                    num++;
                                    break;
                                case 4:
                                    courseIntervalSet.insert(15 + i * 24, 17 + i * 24, c);
                                    timeRecord[i][3]++;
                                    c.addStartTime(15 + i * 24);
                                    num++;
                                    break;
                                case 5:
                                    courseIntervalSet.insert(19 + i * 24, 21 + i * 24, c);
                                    timeRecord[i][4]++;
